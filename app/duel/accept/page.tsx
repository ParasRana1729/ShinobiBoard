...
export default async function DuelAcceptPage({
  ...
  if (!token) {
    return (
      <main className="mx-auto max-w-xl py-20 px-4">
        <div className="rounded-2xl border border-sumi/15 bg-surface-card p-8 text-center shadow-tactile-card">
          <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-xl border border-shinobi-flame/30 bg-shinobi-flame/10 text-shinobi-flame">
            <ShieldAlert className="h-7 w-7" />
          </div>
          <h1 className="font-heading text-xl font-bold tracking-tight text-text-primary">Missing Duel Token</h1>
  ...
  try {
    ...
    return (
      <main className="mx-auto max-w-xl py-20 px-4">
        <div className="rounded-2xl border border-sumi/15 bg-surface-card p-8 text-center shadow-tactile-card">
          <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-xl border border-shinobi-gold/30 bg-shinobi-gold/10 text-shinobi-gold">
            <ShieldAlert className="h-7 w-7" />
          </div>
          <h1 className="font-heading text-xl font-bold tracking-tight text-text-primary">Duel Scroll Expired or Invalid</h1>
          <p className="mt-2 text-sm text-text-secondary">
  ...
  if (invite?.used_at && invite.group_id) {
    return (
      <main className="mx-auto max-w-xl py-20 px-4">
        <div className="rounded-2xl border border-sumi/15 bg-surface-card p-8 text-center shadow-tactile-card">
          <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-xl border border-shinobi-teal/30 bg-shinobi-teal/10 text-shinobi-teal">
            <CheckCircle2 className="h-7 w-7" />
          </div>
          <h1 className="font-heading text-xl font-bold tracking-tight text-text-primary">Duel Already Active</h1>
          <p className="mt-2 text-sm text-text-secondary">
    ...
    return (
      <main className="mx-auto max-w-xl py-20 px-4">
        <div className="rounded-2xl border border-sumi/15 bg-surface-card p-8 text-center shadow-tactile-card">
          ...
          <h1 className="font-heading text-xl font-bold tracking-tight text-text-primary">Shadow Clone Warning</h1>
          <p className="mt-2 text-sm text-text-secondary">
          ...
          <div className="mt-6 flex flex-col items-center gap-3">
            <div className="w-full rounded-xl border border-sumi/15 bg-surface-elevated p-3 font-mono text-xs text-text-secondary select-all break-all">
  ...
  return (
    <main className="mx-auto max-w-4xl py-12 px-4 sm:px-6">
      ...
      <div className="text-center">
        <div className="inline-flex items-center gap-1.5 rounded-full border border-sumi/15 bg-surface-elevated px-3 py-1 font-mono text-[11px] uppercase tracking-wide text-text-secondary">
          <Swords className="h-3.5 w-3.5 text-shinobi-gold" /> Versus Protocol Engaged
        </div>
      ...
      <div className="mt-10 grid grid-cols-1 items-stretch gap-6 md:grid-cols-[1fr,auto,1fr]">
        {/* Challenger Card */}
        <div className="relative flex flex-col justify-between overflow-hidden rounded-2xl border border-sumi/15 bg-surface-card p-6 shadow-tactile-card">
          <div className="absolute top-0 right-0 rounded-bl-xl border-b border-l border-shinobi-flame/30 bg-shinobi-flame/10 px-3 py-1 font-mono text-[10px] font-bold uppercase tracking-wider text-shinobi-flame">
            Challenger
          </div>
          ...
          <div>
            <div className="flex items-center gap-4">
              ...
              <div className="min-w-0">
                ...
                <div className="mt-1.5 flex flex-wrap items-center gap-1.5">
                  <span className="inline-flex items-center gap-1 rounded-md border border-sumi/15 bg-sumi/[0.06] px-2 py-0.5 text-[11px] font-medium text-text-secondary">
            ...
            {/* Challenger Stats */}
            <div className="mt-6 grid grid-cols-3 gap-2 border-t border-sumi/10 pt-4 text-center">
              <div className="rounded-xl border border-sumi/10 bg-surface-elevated/40 p-2.5">
        ...
        <div className="flex flex-col items-center justify-center py-4">
          <div className="relative flex h-16 w-16 items-center justify-center rounded-2xl border border-sumi/20 bg-surface-elevated text-xl font-black italic tracking-tighter text-shinobi-gold">
            VS
            <span className="absolute -top-1 -right-1 flex h-2.5 w-2.5">
              <span className="relative inline-flex h-2.5 w-2.5 rounded-full bg-shinobi-gold" />
            </span>
          </div>
          <div className="mt-3 flex items-center gap-1 text-[11px] font-medium text-text-muted font-mono">
      ...
      <div className="mt-8 rounded-2xl border border-sumi/15 bg-surface-card p-5  ">
        ...
        <ul className="mt-3 grid gap-2.5 text-xs text-text-secondary sm:grid-cols-3">
          <li className="flex items-start gap-2 rounded-xl border border-sumi/10 bg-surface-elevated/60 p-3 ">
